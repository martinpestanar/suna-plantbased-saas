...
const IcoBot = () => (
  <svg viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg" width="44" height="44">
    <rect width="44" height="44" rx="14" fill="url(#gradBotDark)" />
    <rect x="11" y="15" width="22" height="17" rx="5" stroke="#D8F3DC" strokeWidth="1.8"/>
    <circle cx="16.5" cy="22.5" r="2.5" fill="#40916C"/>
    <circle cx="27.5" cy="22.5" r="2.5" fill="#40916C"/>
    <path d="M17 28h10" stroke="#D8F3DC" strokeWidth="1.5" strokeLinecap="round"/>
    <path d="M22 15v-4M19 11h6" stroke="#D8F3DC" strokeWidth="1.5" strokeLinecap="round"/>
    <defs>
      <linearGradient id="gradBotDark" x1="0" y1="0" x2="44" y2="44" gradientUnits="userSpaceOnUse">
...
const IcoStock = () => (
  <svg viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg" width="44" height="44">
    <rect width="44" height="44" rx="14" fill="url(#gradStockDark)" />
    <path d="M11 30l8-9 5 5 9-11" stroke="#D8F3DC" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"/>
    <circle cx="33" cy="13" r="3.5" fill="#1B4332"/>
    <defs>
      <linearGradient id="gradStockDark" x1="0" y1="0" x2="44" y2="44" gradientUnits="userSpaceOnUse">
...
const IcoCocina = () => (
  <svg viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg" width="44" height="44">
    <rect width="44" height="44" rx="14" fill="url(#gradCocinaDark)" />
    <rect x="11" y="14" width="22" height="19" rx="4" stroke="#D8F3DC" strokeWidth="1.8"/>
    <path d="M15 22h14M15 27h10" stroke="#D8F3DC" strokeWidth="1.6" strokeLinecap="round"/>
    <circle cx="22" cy="10" r="2.5" fill="#40916C"/>
    <defs>
      <linearGradient id="gradCocinaDark" x1="0" y1="0" x2="44" y2="44" gradientUnits="userSpaceOnUse">
...
const IcoMetrics = () => (
  <svg viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg" width="44" height="44">
    <rect width="44" height="44" rx="14" fill="url(#gradMetricsDark)" />
    <rect x="12" y="24" width="5" height="9" rx="2.5" fill="#40916C"/>
    <rect x="20" y="18" width="5" height="15" rx="2.5" fill="#D8F3DC"/>
    <rect x="28" y="13" width="5" height="20" rx="2.5" fill="#40916C"/>
    <defs>
      <linearGradient id="gradMetricsDark" x1="0" y1="0" x2="44" y2="44" gradientUnits="userSpaceOnUse">
        <stop offset="0%" stopColor="#1B4332" />
        <stop offset="100%" stopColor="#40916C" />
      </linearGradient>
    </defs>
...
export default function Landing() {
  ...
  return (
    <div style={{
      ...
      minHeight: '100vh',
      background: '#080F0C',
      backgroundImage: 'radial-gradient(rgba(64,145,108,0.1) 1px, transparent 1px), radial-gradient(circle at 10% 20%, rgba(27,67,50,0.4) 0%, transparent 50%), radial-gradient(circle at 90% 80%, rgba(64,145,108,0.2) 0%, transparent 50%)',
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{
              ...
              <GrAd className="logo-vibrate" size={20} color="#D8F3DC" />
            </div>
            <span style={{ fontFamily: 'Outfit, sans-serif', fontWeight: 800, color: '#fff', fontSize: 18 }}>Suna GreenApp</span>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
            <button
              ...
              style={{
                ...
                color: '#D8F3DC', fontSize: 13, fontWeight: 700, cursor: 'pointer',
      ...
      <div style={{ width: '100%', maxWidth: 1200, boxSizing: 'border-box' }}>
        ...
        <section style={{ 
          ...
          <div style={{ flex: 1.2, zIndex: 2, display: 'flex', flexDirection: 'column', alignItems: isMobile ? 'center' : 'flex-start', textAlign: isMobile ? 'center' : 'left' }}>
            ...
            <p style={{
              fontSize: isMobile ? 15 : 18, color: 'rgba(255,255,255,0.65)', lineHeight: 1.7,
            ...
            <div style={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', gap: 14, width: '100%', maxWidth: 460 }}>
              ...
              <button
                ...
                onMouseEnter={e => { e.currentTarget.style.borderColor = '#40916C'; e.currentTarget.style.transform = 'translateY(-1px)'; }}
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginTop: 36 }}>
              <div style={{ display: 'flex' }}>
                {['🌿','🥑','🍃'].map((e,i) => (
                  <div key={i} style={{
                    width: 30, height: 30, borderRadius: '50%', border: '2px solid #080F0C',
          ...
          <div style={{ flex: 1, width: '100%', maxWidth: 520, zIndex: 2 }}>
            <div style={{
              ...
              <div style={{ position: 'absolute', top: -30, right: -30, width: 140, height: 140, borderRadius: '50%', background: 'rgba(255,255,255,0.03)', pointerEvents: 'none' }}/>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 18 }}>
                {[
                  { label: 'Ventas Directas', value: 'S/. 1,248', icon: '💰', color: '#D8F3DC' },
                  { label: 'Pedidos por Bot', value: '34 total', icon: '🤖', color: '#D8F3DC' },
                  { label: 'WhatsApp Status', value: 'Activo', icon: '⚡', color: '#40916C' },
                  { label: 'Ahorro Comisiones', value: 'S/. 374', icon: '📈', color: '#D8F3DC' },
                ].map(({ label, value, icon, color }) => (
                  <div key={label} style={{
                    background: 'rgba(0,0,0,0.25)', borderRadius: 16, padding: '14px',
              ...
              {/* Mini bar chart */}
              <p style={{ fontSize: 10, fontWeight: 700, color: 'rgba(216,243,220,0.4)', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 8 }}>Insumos Críticos Controlados</p>
              {[
                ...
                <div key={name} style={{ marginBottom: 10 }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 4 }}>
                    <span style={{ fontSize: 11, color: 'rgba(216,243,220,0.75)', fontWeight: 600 }}>{name}</span>
                  ...
                  <div style={{ height: 6, background: 'rgba(255,255,255,0.07)', borderRadius: 99 }}>
                    <div style={{ height: '100%', width: `${pct}%`, background: pct < 30 ? 'linear-gradient(90deg,#EF4444,#F87171)' : 'linear-gradient(90deg,#40916C,#D8F3DC)', borderRadius: 99 }}/>
                  </div>
                </div>
              ))}
            </div>
        ...
        <section ref={statsRef} style={{
          ...
          <p style={{ textAlign: 'center', fontSize: 11, fontWeight: 800, color: 'rgba(216,243,220,0.4)', textTransform: 'uppercase', letterSpacing: '0.12em', marginBottom: 16 }}>
            Beneficios comprobados por marcas saludables
          </p>
          <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr 1fr' : '1fr 1fr 1fr 1fr', gap: 0, borderRadius: 20, overflow: 'hidden', border: '1px solid rgba(255,255,255,0.07)' }}>
            {STATS.map((s, i) => (
              <div key={i} style={{
                borderRight: (!isMobile && i < 3) || (isMobile && i % 2 === 0) ? '1px solid rgba(255,255,255,0.07)' : 'none',
        ...
        <section id="features" style={{ padding: '72px 24px' }}>
          <div style={{ marginBottom: 44, textAlign: 'center' }}>
            ...
            <h2 style={{ fontFamily: 'Outfit, sans-serif', fontSize: isMobile ? 28 : 38, fontWeight: 900, color: '#fff', lineHeight: 1.2 }}>
            ...
            {FEATURES.map(({ icon, title, desc }, i) => (
              <div key={title} style={{
                ...
                boxShadow: hoveredFeature === i 
                  ? '0 20px 35px -10px rgba(0, 0, 0, 0.5), 0 0 0 1px #40916C' 
              ...
              >
                ...
                <div>
                  <p style={{ fontFamily: 'Outfit, sans-serif', fontSize: 17, fontWeight: 800, color: '#fff', marginBottom: 6 }}>{title}</p>
        ...
        <section id="process" style={{ padding: '0 24px 72px' }}>
          <div style={{ marginBottom: 44, textAlign: 'center' }}>
            ...
            <h2 style={{ fontFamily: 'Outfit, sans-serif', fontSize: isMobile ? 28 : 38, fontWeight: 900, color: '#fff', lineHeight: 1.2 }}>
              ...
              <span style={{ color: '#40916C' }}>3 pasos sencillos</span>
            </h2>
          </div>
            ...
            {STEPS.map(({ num, title, desc }, i) => (
              ...
              >
                <div style={{
                  ...
                  background: hoveredStep === i ? 'linear-gradient(135deg, #40916C, #D8F3DC)' : '#1B4332',
                ...
                <div>
                  <p style={{ fontFamily: 'Outfit, sans-serif', fontSize: 16, fontWeight: 800, color: '#fff', marginBottom: 6, marginTop: isMobile ? 0 : 8 }}>{title}</p>
        ...
        <section id="testimonials" style={{ padding: '0 24px 72px' }}>
          <div style={{ marginBottom: 44, textAlign: 'center' }}>
            ...
            <h2 style={{ fontFamily: 'Outfit, sans-serif', fontSize: isMobile ? 28 : 38, fontWeight: 900, color: '#fff', lineHeight: 1.2 }}>
              ...
              <span style={{ color: '#40916C' }}>canal de ventas directo</span>
            </h2>
          </div>
          <div style={{
            display: 'grid',
            ...
            {TESTIMONIALS.map(({ name, role, quote, rating }, i) => (
              ...
              >
                <div>
                  ...
                  <p style={{ fontSize: 13.5, color: 'rgba(255,255,255,0.75)', lineHeight: 1.7, marginBottom: 20, fontStyle: 'italic' }}>
                    "{quote}"
                  </p>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.4)', fontWeight: 600 }}>{role}</p>
                  </div>
                </div>
              </div>
            ))}
        ...
        <section style={{
          ...
          <div style={{ flex: 1, width: '100%', display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10, textAlign: 'left' }}>
              {[
                'Configuración asistida con IA en 5 minutes',
      ...
      {/* ── FOOTER ── */}
      <footer style={{ width: '100%', padding: '32px 24px', textAlign: 'center', borderTop: '1px solid rgba(255,255,255,0.06)', marginTop: 'auto' }}>
        <p style={{ fontSize: 12.5, color: 'rgba(255,255,255,0.25)', fontWeight: 600 }}>
